...
const ClientsAdd = () => {
    ...
    const save = async (event) => {
        ...
        var { clientsName, clientsRol } = document.forms[0];
        var errors = "";
        errors += clientsName.value < 0 ? "porfavor llene el campo del nombre.\n" : "";
        errors += clientsRol.value < 0 ? "porfavor llene el campo del rol.\n" : "";
        if (errors.length > 0) {
                    ...
                    <div className="card-body">
                        <form onSubmit={save}>
                            <div className="row">
                                ...
                                <div className="col-4">
                                    <div className="form-group">
                                        <label htmlFor="clientesRol" className="control-label">Rut del cliente</label>
                                        <input type="text" name="clientsRol" id="clientsRol" className="form-control" required />
                                    </div>
                                </div>
                                <div className="col-4">
                                </div>
