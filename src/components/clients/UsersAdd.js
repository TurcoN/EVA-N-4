...
const UsersAdd = () => {
    ...
    const cancel = () => {
        var { usersName, nickname, password, level } = document.forms[0];
    ...
    const save = async (event) => {
        ...
        if (errors.length > 0) {
            ...
            const requestOptions = {
                ...
                body: JSON.stringify({ "operatorId": config.operatorId, "name": usersName.value, "nickname": nickname.value, "password": password.value, "level": level.value })
            }
                            ...
                            <div className="row">
                                ...
                                <div className="col-12">
                                    <div className="form-group">
                                        ...
                                        <input type="password" name="password" id="passwprd" className="form-control" required />
                                    </div>
                                </div>
                                <div className="col-12">
                                    <div className="form-group">
